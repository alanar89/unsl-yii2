...
<?php $this->beginBlock('block1'); ?>
  ...
  <div class="col-md-4"> <?= Html::a('Actualizar', ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
       ...
       <?= Html::a('Eliminar cuenta', ['deleteCuenta', 'id' => $model->id], ['class' => 'btn btn-primary','onclick'=>"return confirm('estas seguro? se eliminaran todos sus datos')"]) ?></div>
       ...
       <?php
        ...
        <div class="row">
       <form     method="post" id="formu" action ="index.php?r=nutricionista/pass">
